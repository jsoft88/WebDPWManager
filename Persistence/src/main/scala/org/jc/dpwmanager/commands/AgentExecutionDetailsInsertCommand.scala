...
case class AgentExecutionDetailsInsertCommand(repository: AgentExecutionDetailsRepository, entity: AgentExecutionDetails) extends Command[Int, AgentExecutionDetails, AgentExecutionDetailsInsertResponse](repository, entity){
